...
import AccommodationForm from "@/src/app/components/accommodation-form";
      ...
      >
        <div className="">
          <Typography
            ...
            variant="h3"
            customClassName="text-2xl md:text-4xl lg:text-5xl"
          >
...
export default UpcomingRegistration;
