...
const ArrowUpIcon = dynamic(
  () => import("@/public/assets/svgs/arrow-up-right.svg")
);
    ...
    <section>
      ...
      <div className="lg:px-24 px-5 md:py-16 md:flex md:flex-row flex flex-col-reverse md:space-x-6 space-x-0">
        ...
        <div className="md:w-3/5 w-full md:border-l-2">
          <div className="md:bg-[url('/assets/images/image-frame.png')] bg-[url('/assets/images/sample-meeting-img.png')] -mt-12 w-[100%] h-[500px] bg-no-repeat bg-center"></div>
          <div className="py-4">
            <Typography
              variant="body-reg"
              color="secondary-main"
            ...
            >
              ...
              The things and ALL the 9 gifts of the Spirit in graceful, yet
              mighty demonstrations - Utterances, Revelation and Power, <br />{" "}
              ALL in FULL demonstration with sick bodies healed and diverse
              needs met.
              <br />
              Encounters and experiences in the Glory and Power of God APLENTY &
              CEASELESS, <br />
              Our lives and ministries FOREVER changed... <br />
              This is God&apos;s plan for your life & ministry. <br />
              Tell a friend! Pray, Prepare and attend! Welcome
            </Typography>
          </div>
