...
const ServiceSection = () => {
  ...
  return (
    <section className="py-36 px-16 flex justify-end relative bg-gradient-to-l from-secondary-25">
      ...
      <section className="w-1/2 h-full flex flex-col gap-6">
        <Typography
          variant="h2"
        ...
        <div className="w-3/5 flex flex-col gap-2 mt-6">
