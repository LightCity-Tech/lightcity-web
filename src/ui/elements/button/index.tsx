...
const button = cva("", {
  variants: {
    variant: {
      primary:
        "bg-primary-main border-0 px-[1.5rem] rounded-[6.25rem] hover:bg-primary-700 active:border-2 active:border-[rgba(252, 199, 117, 0.98)]",
      secondary:
        "bg-secondary-25 border-0 px-[1.5rem] rounded-[6.25rem] hover:bg-secondary-50 active:border-2 active:border-secondary-50",
      tertiary:
        "bg-secondary-25 border-0 px-[1.5rem] rounded hover:bg-secondary-50",
      outlined:
        "bg-transparent border-2 px-[1.5rem] rounded-[6.25rem] hover:bg-secondary-main hover:text-white",
